...
for (let i = 0; i < squares.length; i++) {
  squares[i].onclick = () => {
    ...
    // if the square belove your current square
    // is taken you can go ontop of it
    if (
    ...
    } else alert("Cant move here");
    checkBoard();
  };
}
//const test = {1:'player-one',2:'player-two'};test[currentPlayer];
//
